            ...
            if (file_exists($filename)) {
                ...
                if(is_array($_views)) {
                    ...
                    if (empty($custom)) {
                        ...
                        foreach ($posts as $post) {
                            if (!empty($post->image)):
                                echo '<li><a class="attachment-post-thumbnail" href="' . $post->url . '"><img title="' . $post->title . '" src="' . $post->image . '"></a><a href="' . $post->url . '">' . $post->title . '</a></li>';
                            else:
                                echo '<li><a class="attachment-post-thumbnail" href="' . $post->url . '"><img title="' . $post->title . '" src="/themes/ignite/images/avatar.png"></a><a href="' . $post->url . '">' . $post->title . '</a></li>';
                            endif;
                        }
                        echo '</ul>';
                    }
...
function copyright()
{
    ...
    $credit = 'Powered by <a href="http://www.htmly.com" target="_blank">HTMLy</a>';
